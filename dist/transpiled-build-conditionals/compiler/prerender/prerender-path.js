...
function prerenderPath(config, compilerCtx, buildCtx, outputTarget, indexSrcHtml, prerenderLocation) {
    return __awaiter(this, void 0, void 0, function () {
        var msg, timeSpan, results, rendererConfig, hydrateOpts, renderer, hydratedResults, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    msg = outputTarget.hydrateComponents ? 'prerender' : 'optimize html';
                    timeSpan = buildCtx.createTimeSpan(msg + ", started: " + prerenderLocation.path);
                    results = {
                        diagnostics: []
                    };
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    rendererConfig = Object.assign({}, config);
                    hydrateOpts = {};
                    ...
                    renderer = new index_1.Renderer(rendererConfig, null, compilerCtx, outputTarget);
                    return [4 /*yield*/, renderer.hydrate(hydrateOpts)];
                case 2:
                    hydratedResults = _a.sent();
                ...
                case 3:
                    ...
                    util_1.catchError(buildCtx.diagnostics, e_1);
                    return [3 /*break*/, 4];
...
exports.prerenderPath = prerenderPath;
