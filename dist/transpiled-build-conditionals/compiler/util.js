...
function hasServiceWorkerChanges(config, buildCtx) {
    ...
    var wwwServiceOutputs = config.outputTargets.filter(function (o) { return o.type === 'www' && o.serviceWorker && o.serviceWorker.swSrc; });
...
function hasWarning(diagnostics) {
    ...
    return diagnostics.some(function (d) { return d.level === 'warn'; });
}
...
function isDocsPublic(jsDocs) {
    return !(jsDocs && jsDocs.tags.some(function (s) { return s.name === 'internal'; }));
}
