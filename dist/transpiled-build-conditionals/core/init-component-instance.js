...
var init_event_emitters_1 = require("./init-event-emitters");
var proxy_component_instance_1 = require("./proxy-component-instance");
exports.initComponentInstance = function (plt, elm, hostSnapshot, perf, instance, componentConstructor, queuedEvents, i) {
    try {
        if (_BUILD_.profile) {
        ...
        proxy_component_instance_1.proxyComponentInstance(plt, componentConstructor, elm, instance, hostSnapshot, perf);
        if (_BUILD_.event) {
            // add each of the event emitters which wire up instance methods
            // to fire off dom events from the host element
            init_event_emitters_1.initEventEmitters(plt, componentConstructor.events, instance);
        }
        if (_BUILD_.listener) {
            try {
...
exports.initComponentLoaded = function (plt, elm, hydratedCssClass, perf, instance, onReadyCallbacks, hasCmpLoaded) {
    ...
    if ((instance = plt.instanceMap.get(elm)) &&
        ...
        try {
            ...
            patch_1.callNodeRefs(plt.vnodeMap.get(elm));
        ...
        exports.propagateComponentReady(plt, elm);
    }
};
...
exports.propagateComponentReady = function (plt, elm, index, ancestorsActivelyLoadingChildren, ancestorHostElement, cb) {
