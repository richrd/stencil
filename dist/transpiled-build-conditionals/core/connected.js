...
exports.connectedCallback = function (plt, cmpMeta, elm, perf) {
    if (_BUILD_.listener) {
    ...
    if (!plt.hasConnectedMap.has(elm)) {
        ...
        exports.registerWithParentComponent(plt, elm);
...
exports.registerWithParentComponent = function (plt, elm, ancestorHostElement) {
