...
exports.initHostSnapshot = function (domApi, cmpMeta, hostElm, hostSnapshot, attribName) {
    ...
    if (_BUILD_.slotPolyfill) {
        ...
        if (!hostElm['s-cr'] && !domApi.$getAttribute(hostElm, constants_1.SSR_VNODE_ID) && (!domApi.$supportsShadowDom || cmpMeta.encapsulationMeta !== 1 /* ShadowDom */)) {
